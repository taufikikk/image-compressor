...
export default function ImageCompressor() {
  ...
  const applyPreset = (idx) => {
    ...
    if (p.w && p.h) {
      ...
      setTargetW(imgEl.naturalWidth);
      setTargetH(imgEl.naturalHeight);
      setLockRatio(true);
    }
  };
  ...
  const doCompress = async () => {
    ...
    try {
      ...
      const { blob, quality } = await compressImage(
        imgEl, targetW || origW, targetH || origH, targetBytes, format
      );
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ color: "#71717a", fontSize: 13, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            Compress & resize gambar langsung di browser — tanpa upload ke server
          </p>
        </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8 }}>
                    <input type="number" value={targetW || ""} onChange={(e) => handleWidthChange(e.target.value)}
                      placeholder="Width" style={inputStyle} />
                    <span style={{ color: "#52525b", fontSize: 14 }}>×</span>
                    <input type="number" value={targetH || ""} onChange={(e) => handleHeightChange(e.target.value)}
                ...
                <div style={{
                  ...
                  {format === "image/png" && (
                    <p style={{ fontSize: 10, color: "#f59e0b", marginTop: 6 }}>
                      ⚠️ PNG lossless — target ukuran file tidak berlaku
                    </p>
                  )}
                </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <img src={imgSrc} alt="Original" style={{
